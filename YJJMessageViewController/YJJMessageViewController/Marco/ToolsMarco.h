...
typedef void(^nonReturnAndArguments)(void);
typedef  void(^nonReturnHasArguments)(id any);
typedef  void(^nonReturnIntArguments)(int X);
typedef id(^returnAndArguments)(id any);
typedef id(^returnNoArguments)(void);
...
#define SCREEN_WIDTHScale SCREEN_WIDTH/375.0
#endif
