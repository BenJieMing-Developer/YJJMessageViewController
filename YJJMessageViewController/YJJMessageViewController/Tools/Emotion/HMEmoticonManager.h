...
//新增
- (NSAttributedString *_Nullable)emoticonStringWithString:(NSString*_Nullable)Str WithEmojiDic:(NSDictionary*_Nullable)dic StrDic:(NSDictionary*_Nullable)dic1;
